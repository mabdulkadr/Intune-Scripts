...
.CHANGELOG
    ...
    1.5 - Added contract validation, portal-safe boolean parameters, beta Graph endpoints, and terminating paging errors
...
try {
    ...
    # Requests only the fields the report reads
    ...
    $devices = Get-MgGraphAllPages -Uri $devicesUri -MaxResults $MaxDevices
    ...
    $detectedAppLookup = @{}
    $allDetectedApps = Get-MgGraphAllPages -Uri "https://graph.microsoft.com/beta/deviceManagement/detectedApps"
