...
**Repair Intune Stuck Sync** is an Intune remediation package that restores devices where Intune activity has stalled even though the management stack is still installed.
...
* Written to `<SystemDrive>\IntuneLogs\Repair-IntuneStuckSync\`
...
### Logging
* `<SystemDrive>\IntuneLogs\Repair-IntuneStuckSync\`
