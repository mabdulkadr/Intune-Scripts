...
├── Clear-RecycleBin
├── Clear-TeamsClientCache
├── Clear-UserProfileTempFiles
├── Disable-FastStartup
├── Disable-IPv6Protocol
├── Disable-LocalNetworkAccessRestrictions
├── Disable-SMBv1Protocol
├── Disable-StartMenuWebSearchIntegration
├── Enable-DotNetFramework35Feature
├── Enable-RemoteDesktop
├── Enable-WinRMService
├── Ensure-GPOBackupMonthly
├── Ensure-SystemRestorePointMonthly
├── Get-AlwaysInstallElevatedStatus
...
├── Get-WindowsHelloEnrollmentMethods
├── Get-WindowsHelloLastUsedMethod
...
├── Remove-TeamsPersonalChat
├── Remove-WindowsBackupConfiguration
├── Remove-WindowsConsumerApps
├── Repair-ADSecureChannel
├── Repair-Disk
├── Repair-DiskFileSystem
├── Repair-IntuneSyncService
├── Repair-LocalAdministratorAccount
├── Repair-WindowsComponentStore
├── Repair-WindowsTimeService
├── Repair-WindowsUpdateComponents
├── Reset-SCCMUpdatePolicy
├── Reset-WindowsUpdateComponents
├── Restart-ComputerForced
├── Restart-SystemService
├── Restart-WindowsSearch
├── Restart-WindowsUpdate
├── Search-RemediationScripts
├── Set-AutomaticTimeZone
├── Set-BIOSFirmwarePassword
├── Set-CachedLogonCountZero
├── Set-OneDriveFolderOfflineAvailability
├── Set-SystemServiceConfiguration
├── Show-LowDiskSpaceAlert
├── Show-RebootToastNotification
├── Show-RebootWarningNotification
├── Show-RecycleBinSizeWarning
├── Show-SystemToastNotification
├── Show-UptimeRestartNotification
├── Show-Windows11UpgradeAlert
├── Start-DiskCleanup
├── Stop-ComputerImmediate
├── Test-DeviceDriverIssues
├── Test-DiskHealth
├── Test-LAPSUserAccount
├── Test-NetworkSpeed
├── Test-PnPDeviceStatus
├── Test-SCCMClientHealth
