...
$ScriptName   = 'Invoke-LogoffCurrentUser--Detect.ps1'
$SolutionName = 'Invoke-LogoffCurrentUser'
$ScriptMode   = 'Detection'

$SystemDrive = if ($env:SystemDrive) { $env:SystemDrive.TrimEnd('\') } else { [System.IO.Path]::GetPathRoot($env:SystemRoot).TrimEnd('\') }
$LogRoot     = Join-Path $SystemDrive "IntuneLogs\$SolutionName"
$LogFile     = Join-Path $LogRoot 'Invoke-LogoffCurrentUser--Detect.txt'
$BannerLine  = '=' * 78
...
Finish-Script -ExitCode 1 -Level 'WARNING' -Message 'Detection is configured to always trigger current-user logoff remediation.' -OutputMessage 'Non-Compliant: Current user logoff is required.'
