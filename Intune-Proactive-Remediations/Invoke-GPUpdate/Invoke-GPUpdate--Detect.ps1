...
.NOTES
    Script  : Invoke-GPUpdate--Detect.ps1
    Updated : 2026-02-15
#>

#region ---------- Configuration ----------

$ScriptName   = 'Invoke-GPUpdate--Detect.ps1'
$SolutionName = 'Invoke-GPUpdate'
$ScriptMode   = 'Detection'

$SystemDrive = if ($env:SystemDrive) { $env:SystemDrive.TrimEnd('\') } else { [System.IO.Path]::GetPathRoot($env:SystemRoot).TrimEnd('\') }
$LogRoot     = Join-Path $SystemDrive "IntuneLogs\$SolutionName"
$LogFile     = Join-Path $LogRoot 'Invoke-GPUpdate--Detect.txt'
$BannerLine  = '=' * 78
...
Finish-Script -ExitCode 1 -Level 'WARNING' -Message 'Detection is configured to always trigger gpupdate remediation.' -OutputMessage 'Non-Compliant: A Group Policy update is needed.'
