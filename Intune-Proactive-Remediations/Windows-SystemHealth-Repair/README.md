...
# 🛠️ Windows System Health Repair
...
**Windows System Health Repair** is an Intune remediation package that detects and repairs component store corruption and system file integrity violations on managed devices.
...
* Written to `<SystemDrive>\IntuneLogs\Windows-SystemHealth-Repair\`
...
### Logging
* `<SystemDrive>\IntuneLogs\Windows-SystemHealth-Repair\`
