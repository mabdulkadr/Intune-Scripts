...
.DESCRIPTION
    This remediation script checks for the Windows Search service and restarts it
...
.EXAMPLE
    .\RestartWindowsSearchService--Remediate.ps1
...
$ScriptName     = 'RestartWindowsSearchService--Remediate.ps1'
$ScriptBaseName = 'RestartWindowsSearchService--Remediate'
