...
if (-not $needNotice) {
    Write-Output "Nothing to remediate. PendingReboot=$PendingReboot | UptimeDays=$UptimeDays"
    exit 0
}
...
if ($PendingReboot -and $needForce) {
    ...
    Write-Output "Pending reboot detected. Restart scheduled in $GraceSeconds seconds. Scheduled=$ok"
}
#endregion =====================================================================
...
Write-Output "Remediation finished. PendingReboot=$PendingReboot | UptimeDays=$UptimeDays"
exit 0
#endregion =====================================================================
