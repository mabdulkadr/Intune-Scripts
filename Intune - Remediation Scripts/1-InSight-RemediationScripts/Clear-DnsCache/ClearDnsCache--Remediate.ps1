...
.DESCRIPTION
    This remediation script runs `ipconfig /flushdns` to clear cached DNS
    entries on the device.

    It is used to force the system to rebuild DNS name resolution from fresh
    lookups.
...
$ScriptName     = 'ClearDnsCache--Remediate.ps1'
$ScriptBaseName = 'ClearDnsCache--Remediate'
...
Write-Log -Level 'OK' -Message 'DNS resolver cache was flushed.'
