...
.DESCRIPTION
    This remediation script enables Microsoft Defender behavior monitoring using:
...
.EXAMPLE
    .\GetRealTimeBehaviour--Remediate.ps1
...
$ScriptName     = 'GetRealTimeBehaviour--Remediate.ps1'
$ScriptBaseName = 'GetRealTimeBehaviour--Remediate'
...
try {
    Set-MpPreference -DisableBehaviorMonitoring $false
    Write-Log -Message 'Microsoft Defender behavior monitoring was enabled.' -Level 'OK'
