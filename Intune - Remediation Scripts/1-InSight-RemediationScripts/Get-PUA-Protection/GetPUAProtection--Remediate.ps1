...
.DESCRIPTION
    This remediation script enables Microsoft Defender Potentially Unwanted
    Application (PUA) protection using:
...
.EXAMPLE
    .\GetPUAProtection--Remediate.ps1
...
$ScriptName     = 'GetPUAProtection--Remediate.ps1'
$ScriptBaseName = 'GetPUAProtection--Remediate'
...
try {
    Set-MpPreference -PUAProtection Enabled
    Write-Log -Message 'Microsoft Defender PUA protection was enabled.' -Level 'OK'
