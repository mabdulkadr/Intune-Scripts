...
.DESCRIPTION
    This remediation script enables Microsoft Defender Network Protection using:
...
.EXAMPLE
    .\GetNetworkProtection--Remediate.ps1
...
$ScriptName     = 'GetNetworkProtection--Remediate.ps1'
$ScriptBaseName = 'GetNetworkProtection--Remediate'
...
try {
    Set-MpPreference -EnableNetworkProtection Enabled
    Write-Log -Message 'Microsoft Defender Network Protection was enabled.' -Level 'OK'
