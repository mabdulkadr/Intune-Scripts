<#
.SYNOPSIS
    Disable the SMBv1 server protocol.

.DESCRIPTION
    This remediation script disables SMBv1 on the local device by calling
    `Set-SmbServerConfiguration -EnableSMB1Protocol 0`.

    It is intended to run after the paired detection script reports that SMBv1
    is still enabled.
...
$ScriptName     = 'DisableSMBv1--Remediate.ps1'
$ScriptBaseName = 'DisableSMBv1--Remediate'
...
Write-Log -Message 'Disabling SMBv1 using Set-SmbServerConfiguration.'

# Run the original remediation command without altering its behavior.
Set-SmbServerConfiguration -EnableSMB1Protocol 0

Write-Log -Message 'SMBv1 remediation command completed.' -Level 'OK'
