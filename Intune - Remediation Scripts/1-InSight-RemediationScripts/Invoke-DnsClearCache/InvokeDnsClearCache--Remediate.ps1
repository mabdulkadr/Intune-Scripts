...
.DESCRIPTION
    ...
    to clear the local DNS resolver cache on the device.

.RUN AS
    Admin

.EXAMPLE
    .\InvokeDnsClearCache--Remediate.ps1
...
$ScriptName     = 'InvokeDnsClearCache--Remediate.ps1'
$ScriptBaseName = 'InvokeDnsClearCache--Remediate'
...
$SolutionName = 'InvokeDnsClearCache'
...
Write-Log -Message 'Clearing the local DNS client cache.'
Clear-DnsClientCache
Write-Log -Message 'DNS cache clear command completed.' -Level 'OK'
