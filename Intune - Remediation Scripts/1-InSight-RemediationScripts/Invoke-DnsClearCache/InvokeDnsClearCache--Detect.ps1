<#
.SYNOPSIS
    Always trigger the DNS cache clear remediation workflow.
...
.EXAMPLE
    .\InvokeDnsClearCache--Detect.ps1
...
$ScriptName     = 'InvokeDnsClearCache--Detect.ps1'
$ScriptBaseName = 'InvokeDnsClearCache--Detect'
