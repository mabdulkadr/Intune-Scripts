<#
.SYNOPSIS
    Enable Microsoft Defender cloud-delivered protection and automatic sample submission.

.DESCRIPTION
    This remediation script configures Microsoft Defender using:
...
.EXAMPLE
    .\GetCloudDeliveredProtection--Remediate.ps1
...
$ScriptName     = 'GetCloudDeliveredProtection--Remediate.ps1'
$ScriptBaseName = 'GetCloudDeliveredProtection--Remediate'
...
try {
    Set-MpPreference -MAPSReporting Advanced
    Write-Log -Message 'MAPSReporting was set to Advanced.'

    Set-MpPreference -SubmitSamplesConsent SendAllSamples
    Write-Log -Message 'SubmitSamplesConsent was set to SendAllSamples.' -Level 'OK'
