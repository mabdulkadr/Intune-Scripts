<#
.SYNOPSIS
    Disable Delivery Optimization verbose logging.

.DESCRIPTION
    This remediation script disables verbose Delivery Optimization logging by
    running the built-in `Disable-DeliveryOptimizationVerboseLogs` command.

.RUN AS
    System

.EXAMPLE
    .\DisableDeliveryOptimizationVerboseLogging--Remediate.ps1
...
$ScriptName     = 'DisableDeliveryOptimizationVerboseLogging--Remediate.ps1'
$ScriptBaseName = 'DisableDeliveryOptimizationVerboseLogging--Remediate'
...
$SolutionName = 'DisableDeliveryOptimizationVerboseLogging'
...
Write-Log -Message 'Disabling Delivery Optimization verbose logging.'

Disable-DeliveryOptimizationVerboseLogs

Write-Log -Message 'Delivery Optimization verbose logging was disabled.' -Level 'OK'
