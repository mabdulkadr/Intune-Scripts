<#
.SYNOPSIS
    Always trigger the current-user logoff remediation workflow.
...
.EXAMPLE
    .\InvokeCurrentUserLoggedOff--Detect.ps1
...
$ScriptName     = 'InvokeCurrentUserLoggedOff--Detect.ps1'
$ScriptBaseName = 'InvokeCurrentUserLoggedOff--Detect'
