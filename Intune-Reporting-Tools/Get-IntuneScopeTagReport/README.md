...
**Get Intune Scope Tag Report** is a PowerShell reporting script that lists all scope tags and shows which policies, apps, and configurations reference each tag. Identifies unused tags and untagged policies. Important for multi-team Intune environments with delegated administration.
...
### Logging
* `C:\ProgramData\get-intunescopetagreport\Logs\`
