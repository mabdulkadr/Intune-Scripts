<#
.SYNOPSIS
    PowerShell Script to Sync All Enrolled Devices in Intune

.DESCRIPTION
    This script connects to the Microsoft Graph API to sync all enrolled devices in an Intune tenant.
    It installs the required Microsoft.Graph.Authentication module if not already installed, connects to the Microsoft Graph API using either app-based or user-based authentication, lists all managed devices in Intune, and sends a sync command to each device.
    It handles paginated results when listing devices and ensures proper disconnection from the Graph API at the end.

.AUTHOR
    © Mohammad Omar. All rights reserved. Visit: momar.tech

.NOTES
    Ensure the application has the necessary permissions in Azure AD to access Intune resources.
    Date: 2024-07-11
    Version: 1.0
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYjfOwyDGV8wuf
# yvZIeYVwr1j6ue5DYojOeuRZmX+m5KCCIRwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# gjcCARUwLwYJKoZIhvcNAQkEMSIEIFKApxQfYkNGqYHhMOVrOVvchf9cgLW3GyCv
# aHdLqAwPMA0GCSqGSIb3DQEBAQUABIICALvYgXF37M0eR5QL7YVbuEt4qTsjNbi8
# kfKqDk1Wvujt0kCVdTzQKyIByLtB38E6LmFXZqMZ4gykQvjnk8FxOxXMNNWtmBPM
# nhvHpV3zzIeyPIJG59Kzd+dJ/3DmO/QiN9Rz4CMoOOruYVTJC17X9HsaSkLun3ai
# 9sMWnv7+OIONMDP6RAXFmCXMKd4/MGfsFV82eB8MIdxlNBLxTTf8QJn3RXblNIiG
# Fhlx37PEuI8FuamTyLMclerjTox1tgj9OODneEFEuO5JaYSgUeqmpOukcrd2VuQ/
# vsLZhtVtQ8zsrlPYUM/wZ2oA7MpfTs7dvERC7q4URM0v+zdkjeIIq6L8vnGv/XhV
# U+R8blm3WwQ+y86I9VoEQslPWnwFOxmhoWNEvq7Hf5/gHZub4BsaCXhiGAFVqlN/
# J2DnOEbOHF2Yklhn3kM1dbC5yoYDjSc1Sp3K4N2AVM4ITU7Rb3nOuNuJW0E0Lyek
# Lb/XH4e7g9/AV90YtohC/qJb6F/ZEbH/X3V1HcanJHtNfus+Tl+uU7bYtE+GdRZJ
# yVyQwJ/zKfcF4Um/Oq2Aa9yPJL7T8OgmHz+QF+z+v3Uuw8C61QuCnAO1+nBXuced
# eThgY3xEeGENftViUmwgIyGoasG4J46pnskM24MxDY2f6lJM6PdCC25xgouQITVo
# uxdet/C0c1vpoYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkG
# A1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMTswOQYDVQQDEzJEaWdp
# Q2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hBMjU2IFRpbWVTdGFtcGluZyBDQQIQ
# BUSv85SdCDmmv9s/X+VhFjANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3DQEJAzEL
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIzMTExNTIwNDgxNVowLwYJKoZI
# hvcNAQkEMSIEIJ0KVHbkFe7Df67cJqdsBUqOAJiaY/W49MCBNow02HasMA0GCSqG
# SIb3DQEBAQUABIICAE+QVBh65qblof7+sUmFKOHdBEI1QOX5xGDo46HYb1ivam+F
# 7TT4/7EDlGuvBmAMvjqbFykao39g/0TLDDyF2FbJCtIg+FAYbn9KdSfVs5jkKGbF
# ZG8NNM5ozQjZjMikNfTyJ+635teBPX1KnzMoJRjuX99XJvza+/5R0hSYn8n3u5XI
# UdVpOSVvQQJiokN8dHh40GhYaebqhnu80BbAPDIhJuPXitC4sV521IA7w4hzt5+I
# oXvdaSnkSB2a8bhh1QC2YCgUpT+GjHZu8qS56h4BpHmyMlGt1eTO8des850zKzdd
# Ozi4+BxVNuZvfe9wQxVvw+ejcduIjAvH2aQLuu/3V31Qd/kuxGLyBUzeaxusC6LP
# 3M8HHD/+vhNR6Y503EsGdvOtJa59EcBljUo5cfkFTcs6CNYP4tHLLXFSkOOdmK2y
# CnFCUs5unWUfyIBBfxMYAGGWck5u8drpd4i4mfqwv8L6pQfAVfbF/MH2dz3Gb40q
# 3XjtHuaqbQoh8OHfVftSci1PTlCjZo28sG5kpEE3ZrpTTXj+kvt/2Zzgvsz2phEp
# +BNhgVWRmBlx362hn6ppbBfSKry3I/QaCwN7jCTKFFKAHQYnC+JZJFN4h9alFrQz
# BJEgGtoDsaA6aonK2/ItG+Vo45gZOv2sQlvASmSW8x22J+DcJXnChlzWXv7m
