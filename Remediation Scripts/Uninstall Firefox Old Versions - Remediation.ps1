...
.DESCRIPTION
    ...
    3. Checks for the existence of the helper.exe file in the Mozilla Firefox installation directory.
    4. Removes any remaining Firefox-related files and directories from the system, including "C:\Program Files (x86)\Mozilla Firefox" and "C:\Program Files (x86)\Mozilla Maintenance Service".
    5. Logs the progress and any errors encountered during the process to a specified log file.
...
if ($uninstallStrings.Count -gt 0) {
    ...
    # Check and remove specific Firefox-related directories if they exist
    $specificDirs = @(
