<#
.SYNOPSIS
    Automates the creation and deployment of Win32 applications using Winget and Microsoft Intune.

.DESCRIPTION
    This script streamlines the packaging, deployment, and update management of Winget-based applications in Microsoft Intune. Key features include:

    - Interactive selection of apps via Winget GridView
    ...
    - Optional support for Available Installations
    - Full integration with Microsoft Graph SDK v2

    It supports both PowerShell 5.1 and 7, auto-switching if necessary, and is compatible with the Winget PowerShell module and modern Intune content packaging tools.

    ✔ Built-in logging for automation (e.g., Azure Runbooks)
    ✔ Code signing supported
    ✔ Updated for modern MG.Graph SDK and multilingual app handling

    Special thanks to Nick Brown (https://twitter.com/techienickb) for Graph SDK enhancements.

.INPUTS
    App ID and App Name selected via Winget GridView.

.OUTPUTS
    Inline output messages during packaging and deployment.

.NOTES
    Version:        5.0.4
    Author:         Andrew Taylor
    Website:        https://andrewstaylor.com
    Twitter:        @AndrewTaylor_2
    Last Updated:   20/09/2024
    License:        GPL (https://github.com/andrew-s-taylor/public/blob/main/LICENSE)
    Repo:           https://github.com/andrew-s-taylor/public
#>
