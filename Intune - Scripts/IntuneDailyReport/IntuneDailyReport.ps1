<#
.SYNOPSIS
    Generates a comprehensive daily report for Intune, covering expiring app registrations, Apple certificates, compliance status, security risks, and more.

.DESCRIPTION
    This script connects to Microsoft Intune via the Microsoft Graph API and generates an automated daily health report for the Intune tenant. 
    The report includes key details about device compliance, security issues, expiring app registrations, and licensing concerns.

.Core Features
    - Checks for expiring app registrations and secrets.
    - Monitors Apple Push Notification (APN), VPP, and DEP certificate expirations.
    - Identifies unused licenses and duplicate license assignments in Entra ID.
    - Detects non-compliant devices and missing security configurations.
    - Retrieves audit events and administrative alerts.
    - Scans for failed sign-ins within the last 24 hours.
    - Tracks Windows Defender malware alerts and firewall status.
    - Lists Windows devices running outdated OS versions.
...
.INPUTS
    ...
    - AppID       : Azure AD App Registration ID for authentication.
    - ClientSecret: Corresponding App Registration secret.

.OUTPUTS
    - Generate a detailed HTML report with all collected Intune insights.
    - Saves an HTML report file locally.

.EXAMPLE
    # Run the script manually by providing required parameters:
    .\IntuneDailyReport.ps1 -Tenant "yourtenant.onmicrosoft.com" -ClientID "xxxx-xxxx-xxxx-xxxx" -ClientSecret "your-secret"
    
    # This will generate a report and email it to the specified recipient.

.LINK
    Microsoft Graph API Documentation: https://learn.microsoft.com/en-us/graph/
    Intune PowerShell SDK: https://github.com/microsoftgraph/msgraph-sdk-powershell
#>
...
param
(
 [string]$tenant        = "<Your-Tenant-ID>",   #Tenant ID (optional) for when automating and you want to use across tenants instead of hard-coded
 [string]$clientid      = "<Your-App-ID>",      #ClientID is the type of Azure AD App Reg ID
 [string]$clientsecret  = "<Your-App-Secret>"   #ClientSecret is the type of Azure AD App Reg Secret
        )
...
Write-Host "   Installing Intune modules                                            " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Detecting updated applications in the last week                      " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
$updatedappoutput = @()
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Admin Alerts                                                   " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
##Get all events
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Licenses                                                       " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
##Get the domain name
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Secure Score                                                   " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Non-Compliant Device                                           " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Win365 Unused Devices                                          " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
"@
$filepath = "$PSScriptRoot\report" + $clouddeviceid + ".txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Failed Sign-Ins                                                " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check App Installs                                                   " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
$tempfilepath = $PSScriptRoot + "\appreport.txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check App Protection                                                 " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   VPP Cert Expiry                                                      " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
#MDM Push
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Unsupported Versions                                                 " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
$supportedversions = @()
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   AV and Malware Checks                                                " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
$malware = @()
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Firewall Checks                                                      " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
$tempfilepath = $PSScriptRoot + "\fwreport.txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Security Tasks                                                       " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Feature Update Policies                                        " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   CCheck App Registrations                                             " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Stale Devices                                                        " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Service Health Issues                                                " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
$yesterday = (Get-Date).AddDays(-1).ToString("yyyy-MM-ddTHH:mm:ss.fffZ")
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Service Health Messages                                              " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
$yesterday = (Get-Date).AddDays(-1).ToString("yyyy-MM-ddTHH:mm:ss.fffZ")
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Service Health Overview                                              " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Check Connectors                                                     " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Feature Update Checks                                                " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
$tempfilepath = $PSScriptRoot + "\featureupdates.txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Expedited Update Checks                                              " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
$tempfilepath = $PSScriptRoot + "\expeditedupdates.txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Driver Update Checks                                                 " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
...
$tempfilepath = $PSScriptRoot + "\driverupdates.txt"
...
##################################################################################################################################
Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "   Create HTML file                                                     " -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
   
$readabledate = get-date -format dd-MM-yyyy-HH-mm-ss
$ReportContent = Get-Content "$PSScriptRoot\Report-Template.html" | Out-String

$Section1Head = "Report generated for $domain<br>at $formattedDateTime"
...
$ReportContent = $ReportContent.Replace('$Section1Head',$Section1Head)
$ReportContent = $ReportContent.Replace('$Section1Body',$Section1Body)
$ReportContent = $ReportContent.Replace('$Section2Head',$Section2Head)
$ReportContent = $ReportContent.Replace('$Section2Body',$Section2Body)
$ReportContent = $ReportContent.Replace('$Section3Head',$section3Head)
$ReportContent = $ReportContent.Replace('$Section3Body',$Section3Body)
$ReportContent = $ReportContent.Replace('$Section4Head',$section4Head)
$ReportContent = $ReportContent.Replace('$Section4Body',$Section4Body)
$ReportContent = $ReportContent.Replace('$Section5Head',$section5Head)
$ReportContent = $ReportContent.Replace('$Section5Body',$Section5Body)
$ReportContent = $ReportContent.Replace('$Section6Head',$section6Head)
$ReportContent = $ReportContent.Replace('$Section6Body',$Section6Body)
$ReportContent = $ReportContent.Replace('$Section7Head',$section7Head)
$ReportContent = $ReportContent.Replace('$Section7Body',$Section7Body)
$ReportContent = $ReportContent.Replace('$Section8Head',$section8Head)
$ReportContent = $ReportContent.Replace('$Section8Body',$Section8Body)
$ReportContent = $ReportContent.Replace('$Section9Head',$section9Head)
$ReportContent = $ReportContent.Replace('$Section9Body',$Section9Body)
$ReportContent = $ReportContent.Replace('$Section10Head',$section10Head)
$ReportContent = $ReportContent.Replace('$Section10Body',$Section10Body)
$ReportContent = $ReportContent.Replace('$Section11Head',$section11Head)
$ReportContent = $ReportContent.Replace('$Section11Body',$Section11Body)
$ReportContent = $ReportContent.Replace('$Section12Head',$section12Head)
$ReportContent = $ReportContent.Replace('$Section12Body',$Section12Body)
$ReportContent = $ReportContent.Replace('$Section13Head',$section13Head)
$ReportContent = $ReportContent.Replace('$Section13Body',$Section13Body)
$ReportContent = $ReportContent.Replace('$Section14Head',$section14Head)
$ReportContent = $ReportContent.Replace('$Section14Body',$Section14Body)
$ReportContent = $ReportContent.Replace('$Section15Head',$section15Head)
$ReportContent = $ReportContent.Replace('$Section15Body',$Section15Body)
$ReportContent = $ReportContent.Replace('$Section16Head',$section16Head)
$ReportContent = $ReportContent.Replace('$Section16Body',$Section16Body)
$ReportContent = $ReportContent.Replace('$Section17Head',$section17Head)
$ReportContent = $ReportContent.Replace('$Section17Body',$Section17Body)
$ReportContent = $ReportContent.Replace('$Section18Head',$section18Head)
$ReportContent = $ReportContent.Replace('$Section18Body',$Section18Body)
$ReportContent = $ReportContent.Replace('$Section19Head',$section19Head)
$ReportContent = $ReportContent.Replace('$Section19Body',$Section19Body)
$ReportContent = $ReportContent.Replace('$Section20Head',$section20Head)
$ReportContent = $ReportContent.Replace('$Section20Body',$Section20Body)
$ReportContent = $ReportContent.Replace('$Section21Head',$section21Head)
$ReportContent = $ReportContent.Replace('$Section21Body',$Section21Body)
$ReportContent = $ReportContent.Replace('$Section22Head',$section22Head)
$ReportContent = $ReportContent.Replace('$Section22Body',$Section22Body)
$ReportContent = $ReportContent.Replace('$Section23Head',$section23Head)
$ReportContent = $ReportContent.Replace('$Section23Body',$Section23Body)
$ReportContent = $ReportContent.Replace('$Section24Head',$section24Head)
$ReportContent = $ReportContent.Replace('$Section24Body',$Section24Body)
$ReportContent = $ReportContent.Replace('$Section25Head',$section25Head)
$ReportContent = $ReportContent.Replace('$Section25Body',$Section25Body)
$ReportContent = $ReportContent.Replace('$Section26Head',$section26Head)
$ReportContent = $ReportContent.Replace('$Section26Body',$Section26Body)
$ReportContent = $ReportContent.Replace('$Section27Head',$section27Head)
$ReportContent = $ReportContent.Replace('$Section27Body',$Section27Body)
$ReportContent = $ReportContent.Replace('$Section28Head',$section28Head)
$ReportContent = $ReportContent.Replace('$Section28Body',$Section28Body)
...
$filename = "IntuneDailyReport-$timestamp.html"

# Define full path
$filepath = "$PSScriptRoot\$filename"

# Final Report
$TempReport = word-wrap -chunk $ReportContent
$TempReport | Out-File -FilePath $filepath -Encoding UTF8

Write-Host "Report saved as: $filepath" -ForegroundColor Green
