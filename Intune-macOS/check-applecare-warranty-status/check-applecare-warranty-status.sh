...
#   - For more scripts and guides, visit: momar.tech
...
# Execution guard - allows sourcing without auto-execution
# (Logic above runs top-level for Intune custom attribute compatibility)
